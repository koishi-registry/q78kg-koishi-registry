export const config = {
  ...
  OPTIMAL_WORKERS_MULTIPLIER: parseInt(process.env.OPTIMAL_WORKERS_MULTIPLIER || "5"),

  // NPM 相关配置
  NPM_REGISTRY_BASE: process.env.NPM_REGISTRY_BASE || "https://registry.npmmirror.com",
  ...
  VALID_PACKAGE_PATTERN: new RegExp(process.env.VALID_PACKAGE_PATTERN || "^(?:@[^/]+\/)?koishi-plugin-[\\w-]+$"),
};
